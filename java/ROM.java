import rom.details.BNCXCurve;
import rom.details.CurveDetails;
import rom.field.BNCXCurveModulus;
import rom.field.FieldDetails;
import rom.mod.BNCurve;
import rom.mod.ModCurve;
...
/*** Enter Some Field details here  ***/
	...
	public static final ModCurve MOD_CURVE = new BNCurve();
...
/* Don't Modify from here... */
	...
	public static final int FEXCESS =((int)1<<(BASEBITS*NLEN-MOD_CURVE.getModBits()));
	public static final int OMASK=(int)(-1)<<(MOD_CURVE.getModBits()%BASEBITS);
	public static final int TBITS=MOD_CURVE.getModBits()%BASEBITS; // Number of active bits in top word
