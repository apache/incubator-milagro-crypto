...
import milagro.ROM;
import milagro.RSA;
import milagro.RSA.private_key;
import milagro.RSA.public_key;
...
public class TestRSA {
	...
	public void main() {
		...
		public_key pub = new public_key(ROM.FFLEN);
		private_key priv = new private_key(ROM.HFLEN);
		...
		System.out.print("Ciphertext= 0x");
		RSA.printBinary(C);
